...
%--------------------------------------------------------
\begin{document}
\title[Decomposition of quantum gate into multiplication of gates taken from a given set]{Decomposition of quantum gate into multiplication of gates taken from a given set}
\author{SEDRI}
...
\curraddr[A.~Two]{Sabanci Universitesi}%
\email[A.~Two]{stefano@sabanciuniv.edu}%
